...
$(DEST)/main.o: $(DEST)/diagonalization.mod $(DEST)/itterations.mod
$(DEST)/main.o: $(DEST)/molecular_structure.mod
...
$(DEST)/itterations.mod: $(DEST)/itterations.o
...
$(DEST)/register.mod: $(DEST)/register.o
